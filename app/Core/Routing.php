...
class Routing {
    ...
    public function __construct() {
        $action = array("home", "rejestracja", "submit", "login", "zalogowano", "logout", "dodaj_kat",
            ...
            "dostepnosc_produktu", "kategoria", "dostepnosc_kategorii", "zatwierdz_zmiane", "zmiana_nazwy_kategorii");
        ...
        $controller = array("home/display", "register/display", "register/submit", "login/display",
            ...
            "admin_product_productlist/isavailable", "category_viewcategory/display", "admin_category_category/isavailable", "admin_category_category/nameChange", "admin_category_category/nameChangeForm");
var_dump($_SESSION);
        if (isset($_GET['url'])) {
