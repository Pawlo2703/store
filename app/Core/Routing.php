...
class Routing extends Controller {
    ...
    public function __construct() {
        $action = array("home", "rejestracja", "submit", "login", "zalogowano", "logout", "dodaj_kat",
            ...
            "checkout", "podsumowanie", "loginCheck", "orderCreate", "dokonano_zakupu", "adres_dostawy", "SetAddress", "zamowienia_oplacone", "zamowienie", "pwchange", "zmiana_hasla" );
        ...
        $controller = array("home/display", "register/display", "register/submit", "login/display",
            ...
            "admin_category_categoryactions/displaynamechangeform", "product_viewproduct/display", "product_viewproduct/addProductToCart", "cart_CartView/display", "register_emailCheck/emailconfirmation",
            ...
            "cart_Address/setAddress", "UserProfile_OrdersHistory/ordersView", "UserProfile_OrdersHistory/orderItemsView", "UserProfile_PasswordChange/changePassword", "UserProfile_PasswordChange/display" );
        var_dump($_SESSION);
        if (isset($_GET['url'])) {
