...
class Routing extends Controller {
    ...
    public function __construct() {
        $action = array("home", "rejestracja", "submit", "login", "zalogowano", "logout", "dodaj_kat",
            ...
            "zmiana_hasla", "profil", "frontproducts", "savefrontproducts", "removeFrontProducts");
        ...
        $controller = array("home/display", "register/display", "register/submit", "login/display",
            ...
            "UserProfile_PasswordChange/display", "UserProfile_Profile/display", "admin_product_HomePageProducts/display", "admin_product_HomePageProducts/saveHomePageProducts",
            "admin_product_HomePageProducts/delete");
        var_dump($_SESSION);
        if (isset($_GET['url'])) {
