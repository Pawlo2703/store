...
class Routing extends Controller {
    ...
    public function __construct() {
        $action = array("home", "rejestracja", "submit", "login", "zalogowano", "logout", "dodaj_kat",
            ...
            "checkout", "podsumowanie", "loginCheck", "orderCreate", "dokonano_zakupu", "adres_dostawy", "SetAddress", "zamówienia_oplacone" );
        ...
        $controller = array("home/display", "register/display", "register/submit", "login/display",
            ...
            "cart_Address/setAddress", "UserProfile_OrdersHistory/ordersView");
        var_dump($_SESSION);
        if (isset($_GET['url'])) {
